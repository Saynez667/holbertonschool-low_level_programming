...
dog_t *new_dog(char *name, float age, char *owner)
{
    ...
    dog_t *new_dog;  /* Defined as dog_t */
    ...
    _strcpy(new_dog->name, name);  /* Copy the name */

    /* Set the dog's age */
    new_dog->age = age;

    /* Allocate memory for the owner's name and copy it */
    ...
    _strcpy(new_dog->owner, owner);  /* Copy the owner's name */
